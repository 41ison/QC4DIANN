    ...
    tabItems(
      tabItem(tabName = "filters",
              fluidRow(
                ...
                box(title = "Reconstruction of XIC", status = "primary", solidHeader = TRUE, width = 12, plotOutput("plot1"), collapsible = TRUE),
                box(title = "Density of ions", status = "primary", solidHeader = TRUE, width = 12, plotOutput("plot2"), collapsible = TRUE),
                box(title = "Retention time error", status = "primary", solidHeader = TRUE, width = 12, plotOutput("plot3"), collapsible = TRUE),
                box(title = "Charge state distribution", status = "primary", solidHeader = TRUE, width = 12, plotOutput("plot4"), collapsible = TRUE),
                box(title = "Peptide length", status = "primary", solidHeader = TRUE, width = 12, plotOutput("plot5"), collapsible = TRUE),
                box(title = "Peptides per sample", status = "primary", solidHeader = TRUE, width = 12, plotOutput("plot6"), collapsible = TRUE),
                box(title = "Proteins per sample", status = "primary", solidHeader = TRUE, width = 12, plotOutput("plot7"), collapsible = TRUE),
                box(title = "Sparsity profile", status = "primary", solidHeader = TRUE, width = 12, plotOutput("plot8"), collapsible = TRUE),
                box(title = "Missing vs median abundance", status = "primary", solidHeader = TRUE, width = 12, plotOutput("plot9"), collapsible = TRUE),
                box(title = "Abundance before and after MAD normalization", status = "primary", solidHeader = TRUE, width = 12, plotOutput("plot10"), collapsible = TRUE),
                box(title = "Missed cleavage sites", status = "primary", solidHeader = TRUE, width = 12, plotOutput("plot11"), collapsible = TRUE),
                box(title = "MS1 Profile Correlation", status = "primary", solidHeader = TRUE, width = 12, plotOutput("plot12"), collapsible = TRUE),
                box(title = "QuantUMS scores distribution", status = "primary", solidHeader = TRUE, width = 12, plotOutput("plot13"), collapsible = TRUE),
                box(title = "Gene quantity distribution", status = "primary", solidHeader = TRUE, width = 12, plotOutput("plot14"), collapsible = TRUE)
              )
      ),
      tabItem(tabName = "protein",
              fluidRow(
                ...
                box(title = "QuantUMS score distribution", status = "primary", height = 600, solidHeader = TRUE, width = 12, plotlyOutput("QuantUMS_dist"), collapsible = FALSE),
                box(title = "Principal Component Analysis", status = "primary", height = 600, solidHeader = TRUE, width = 12, plotlyOutput("PCA"), collapsible = FALSE)
          )
      )
    )
  )
